...
drop table if exists euroleague._schedule_factors;

create table euroleague._schedule_factors (
        team_id			text,
	year			integer,
        offensive               float,
        defensive		float,
...
where r.year between 2004 and 2013
);
...
strength=o.strength
from euroleague._schedule_factors o
