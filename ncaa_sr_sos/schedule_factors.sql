...
drop table if exists ncaa_sr._schedule_factors;

create table ncaa_sr._schedule_factors (
	team_id			text,
	year			integer,
        offensive               float,
        defensive		float,
...
strength=o.strength
from ncaa_sr._schedule_factors o
