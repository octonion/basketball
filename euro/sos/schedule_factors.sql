...
drop table if exists euro._schedule_factors;

create table euro._schedule_factors (
        team_id			text,
	year			integer,
        offensive               float,
        defensive		float,
