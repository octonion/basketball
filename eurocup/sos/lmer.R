...
dbWriteTable(con,c("eurocup","_parameter_levels"),parameter_levels,row.names=TRUE)
...
dbWriteTable(con,c("eurocup","_basic_factors"),as.data.frame(combined),row.names=TRUE)
...
jpeg("diagnostics/eurocup_shapiro-francia.jpg")
...
jpeg("diagnostics/eurocup_fitted_vs_residuals.jpg")
plot(f,r)
jpeg("diagnostics/eurocup_q-q_plot.jpg")
