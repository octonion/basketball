...
create table if not exists ncaa_women._schedule_factors_geocoding (
        school_id		integer,
	year			integer,
        offensive               float,
        defensive		float,
...
truncate table ncaa_women._schedule_factors_geocoding;
...
insert into ncaa_women._schedule_factors_geocoding
(school_id,year,offensive,defensive)
(
select o.level::integer,o.year,o.exp_factor,d.exp_factor
from ncaa_women._factors_geocoding o
left outer join ncaa_women._factors_geocoding d
  on (d.level,d.year,d.parameter)=(o.level,o.year,'defense')
where o.parameter='offense'
);

update ncaa_women._schedule_factors_geocoding
...
strength=o.strength
from ncaa_women._schedule_factors_geocoding o
...
from ncaa_women._factors_geocoding f
