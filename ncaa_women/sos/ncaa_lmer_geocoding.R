sink("ncaa_women_lmer_geocoding.txt")
...
join ncaa_women.geocodes site
  on (site.school_id)=(r.location_id)
join ncaa_women.geocodes team
...
dbWriteTable(con,c("ncaa_women","_parameter_levels_geocoding"),parameter_levels,row.names=TRUE)
...
dbWriteTable(con,c("ncaa_women","_basic_factors_geocoding"),as.data.frame(combined),row.names=TRUE)
...
jpeg("ncaa_women_geocoding_shapiro-francia.jpg")
...
jpeg("ncaa_women_geocoding_fitted_vs_residuals.jpg")
plot(f,r)
jpeg("ncaa_women_geocoding_q-q_plot.jpg")
