...
where
TRUE
and r.year between 1980 and 2017
...
dbWriteTable(con,c("ncaa_sr","beta_parameter_levels"),parameter_levels,row.names=TRUE)
...
dbWriteTable(con,c("ncaa_sr","beta_basic_factors"),as.data.frame(combined),row.names=TRUE)
